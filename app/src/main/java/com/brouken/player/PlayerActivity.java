...
import com.brouken.player.adjustment.VideoAdjustmentController;
import com.brouken.player.adjustment.VideoAdjustmentPanel;
...
public class PlayerActivity extends Activity {
    ...
    private VideoAdjustmentController pictureController;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pictureController = new VideoAdjustmentController(this);
        ...
        buttonPicture = new ImageButton(this, null, 0, R.style.ExoStyledControls_Button_Bottom);
        buttonPicture.setImageResource(R.drawable.ic_tune_24dp);
        buttonPicture.setContentDescription(getString(R.string.button_picture));
        buttonPicture.setOnClickListener(view -> {
            new VideoAdjustmentPanel(PlayerActivity.this, pictureController, this::resetHideCallbacks).show();
            resetHideCallbacks();
        });
            ...
            if (windowInsets != null) {
                ...
                if (Build.VERSION.SDK_INT >= 35) {
                    ...
                    Utils.setViewMargins(exoBottomBar,
                            Utils.dpToPx(16) + left,
                            0,
                            Utils.dpToPx(16) + right,
                            Utils.dpToPx(10) + windowInsets.getSystemWindowInsetBottom());
                ...
                Utils.setViewParams(findViewById(R.id.exo_bottom_bar), paddingLeft, 0, paddingRight, 0,
                        marginLeft + Utils.dpToPx(16), 0, marginRight + Utils.dpToPx(16),
                        Utils.dpToPx(10) + bottomBarPaddingBottom);
        ...
        controls.addView(buttonPicture);
...
//            mediaSession.setActive(false);
    ...
    void updateButtons(final boolean enable) {
        ...
        if (buttonPicture != null) {
            Utils.setButtonEnabled(this, buttonPicture, enable);
        }
        if (isTvBox) {
